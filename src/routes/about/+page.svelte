<main class="pt-12">
	<div class="m-auto flex max-w-screen-md grow flex-col gap-8">
		...
		<p class="text-xl leading-8">
			The Journal of Computer Science at UVA (JCS-UVA) was founded to serve as UVA's first official
			student-led journal on grounds. The Journal of Computer Science, in collaboration with the
			Association of Computer Machinery at UVA (ACM), launched in Fall 2024 to provide a medium for
			student expression, research publications, community spotlights, and a comprehensive
			newsletter spanning CS and engineering at UVA. Today, JCS-UVA continues to develop and focus
			on supporting and connecting the UVA CS community.
		</p>
